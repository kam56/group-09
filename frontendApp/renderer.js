...
function onConnect () {
  ...
  client.on('message', (topic, message) => {
      ...
      const msg = document.createElement('div')
		...
		document.getElementById('"heading"').appendChild(msg)

    }else if(topic.includes("throttle")){

      const msg = document.createElement('div')
		msg.className = 'message-body'
		msg.innerText = `${message.toString()}\nOn topic: ${topic}`
		document.getElementById('"throttle"').appendChild(msg)
      ...
      const msg = document.createElement('div')
		msg.className = 'message-body'
		msg.innerText = `${message.toString()}\nOn topic: ${topic}`
		document.getElementById('"speed"').appendChild(msg)
      ...
      const msg = document.createElement('div')
		msg.className = 'message-body'
		msg.innerText = `${message.toString()}\nOn topic: ${topic}`
		document.getElementById('"angle"').appendChild(msg)
      ...
      const msg = document.createElement('div')
		msg.className = 'message-body'
		msg.innerText = `${message.toString()}\nOn topic: ${topic}`
		document.getElementById('"distance"').appendChild(msg)
